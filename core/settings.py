...
This module contains all configuration settings for the Videoflix
...
CSRF_TRUSTED_ORIGINS = os.environ.get(
    ...
    "http://localhost:5500,http://127.0.0.1:5500,http://localhost:5501,http://127.0.0.1:5501,http://localhost:8000,http://127.0.0.1:8000",
).split(",")
...
# Backend URL for static assets in emails
